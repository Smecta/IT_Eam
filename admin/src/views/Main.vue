      ...
      <el-menu router :default-openeds="['1', '3']">
        <el-submenu index="1">
          ...
          <el-menu-item-group>
            ...
            <el-menu-item index="/deviceCategories/list">设备分类列表</el-menu-item>
          </el-menu-item-group>
          <el-menu-item-group title="分类2">
            <el-menu-item index="1-3">新建单位分类</el-menu-item>
            <el-menu-item index="1-2">设备单位列表</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        <el-submenu index="2">
